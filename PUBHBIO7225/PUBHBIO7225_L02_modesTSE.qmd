...
author: "Generative AI acknowledgment: MS Copilot was used to generate alt text for images and to create icons for survey modes"
format:
  revealjs: 
    slide-number: true
    smaller: true
...
## Designing Survey Questions {.pause}
...
## TSE Components Aﬀecting Measurement {.pause}

1.  **Specification Error (Validity)** – error arising when the construct being measured is operationalized (turned into survey questions) in an invalid way; questions do not properly measure the underlying construct
...
## TSE Components Aﬀecting Representation {.pause}
